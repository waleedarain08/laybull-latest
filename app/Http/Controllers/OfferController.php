...
//        return  $bids;
    ...
    public function bid_counter(Request $request)
    {
        ...
        $body                     = 'You just received a counter offer';
        ...
        $this->firebaseNotification($bid->user_id, 'You just received a counter offer', $body);
    ...
    public function acceptOffer($id)
    {
        ...
        $this->firebaseNotification($bid->user_id, 'Your offer has been accepted', $body);
    ...
    public function rejectOffer($id)
    {
        ...
        $this->firebaseNotification($bid->user_id, 'Your offer has been rejected', $body);
